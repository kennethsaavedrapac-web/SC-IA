...
import { Eye, EyeOff, User, Lock, ArrowRight, LogIn, Moon, Sun } from "lucide-react";
...
export default function RegisterView({
  ...
  return (
    <div className="min-h-screen w-full flex flex-col justify-between bg-gradient-to-b from-[#f8fafc] to-[#f1f5f9] dark:from-[#0b0f19] dark:to-[#0f172a] text-slate-800 dark:text-slate-100 relative overflow-hidden transition-colors duration-300">
      ...
      {/* Main Form Content */}
      <main className="flex-1 w-full max-w-md mx-auto px-6 flex flex-col justify-center py-6 z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className={`w-full bg-white dark:bg-slate-900/60 text-slate-800 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 pl-12 pr-4.5 py-3.5 rounded-[20px] border ${
                  nameError 
                ...
                } focus:outline-none focus:ring-[4px] shadow-[0_4px_16px_rgba(0,0,0,0.015)] dark:shadow-none transition-all duration-200 text-[14px] font-medium`}
              />
            </div>
            {nameError && (
          ...
          <div className="space-y-1">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className={`w-full bg-white dark:bg-slate-900/60 text-slate-800 dark:text-white placeholder-slate-400 dark:placeholder-slate-500 pl-12 pr-12 py-3.5 rounded-[20px] border ${
                  passwordError 
                    ? "border-red-500 dark:border-red-500/70 focus:ring-red-500" 
                    : "border-slate-100 dark:border-slate-800/80 focus:border-blue-500 focus:ring-blue-100/50 dark:focus:ring-blue-900/30"
                } focus:outline-none focus:ring-[4px] shadow-[0_4px_16px_rgba(0,0,0,0.015)] dark:shadow-none transition-all duration-200 text-[14px] font-medium`}
          ...
          <button
            ...
            type="submit"
            className="w-full bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-650 active:scale-[0.98] text-white py-3.5 px-5 rounded-[20px] font-bold text-sm tracking-wide shadow-lg shadow-blue-500/20 dark:shadow-blue-900/10 flex items-center justify-center space-x-1.5 transition-all duration-200 cursor-pointer pt-3"
          >
        ...
        <button
          ...
          className="w-full bg-transparent hover:bg-blue-50/20 text-blue-600 dark:text-blue-400 py-3.5 px-5 rounded-[20px] border border-blue-600/35 dark:border-blue-400/30 font-bold text-[13.5px] flex items-center justify-center space-x-2 mt-3.5 hover:scale-[1.01] active:scale-[0.99] transition-all duration-200 cursor-pointer"
        >
